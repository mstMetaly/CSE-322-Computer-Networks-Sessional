...
class RrepHeader : public Header
{
  public:
    ...
    RrepHeader(uint8_t prefixSize = 0,
               ...
               int32_t congestionControlFlag = 0);//task2Added
    /**
     * \brief Get the type ID.
     * \return the object TypeId
     */
    ...
    //task2Added
    void SetCongestionControlFlag(int32_t congestionControlFlag);
    int32_t GetCongestionControlFlag() const;
    //task2AddedEnd
  ...
  private:
    ...
    uint32_t m_congestionControlFlag; //task2Added
};
