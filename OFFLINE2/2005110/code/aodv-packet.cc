...
RrepHeader::RrepHeader(uint8_t prefixSize,
                       ...
                       Ipv4Address origin,
                       Time lifeTime,
                       int32_t congestionControlFlag)//task2Added
    : m_flags(0),
      ...
      m_origin(origin)
{
    ...
    m_congestionControlFlag = congestionControlFlag;//task2Added
}
...
{
    return 19 + 4;//4 added for task2added
}
...
RrepHeader::Serialize(Buffer::Iterator i) const
{
    ...
    i.WriteHtonU32 (m_congestionControlFlag);//task2Added
}
...
RrepHeader::Deserialize(Buffer::Iterator start)
{
    ...
    m_congestionControlFlag = i.ReadNtohU32 ();//task2Added
...
RrepHeader::Print(std::ostream& os) const
{
    ...
    os << " source ipv4 " << m_origin << " lifetime " << m_lifeTime <<  " congestion flag " << m_congestionControlFlag << " acknowledgment required flag " << (*this).GetAckRequired();//task2Added
}
...
//task2Added
void
RrepHeader::SetCongestionControlFlag(int32_t congestionControlFlag){
  m_congestionControlFlag = congestionControlFlag;
}
//end
//task2Added
int32_t
RrepHeader::GetCongestionControlFlag() const
{
  return m_congestionControlFlag;
}
//end
...
RrepHeader::operator==(const RrepHeader& o) const
{
    return (m_flags == o.m_flags && m_prefixSize == o.m_prefixSize && m_hopCount == o.m_hopCount &&
            ...
            m_lifeTime == o.m_lifeTime && m_lifeTime == o.m_lifeTime && m_congestionControlFlag == o.m_congestionControlFlag);//task2Added
}
